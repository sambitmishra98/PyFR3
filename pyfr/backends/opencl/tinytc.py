        ...
        try:
            ...
            try:
                ...
                self.backend.bench_kern |= {
                    f'test-tinytc_a-tags': matrix_tag,
                    f'test-tinytc_a-rows': a.nrow, 
                    f'test-tinytc_a-cols': a.ncol,
                    f'test-tinytc_b-rows': b.nrow, 
                    f'test-tinytc_b-cols': b.ncol,
                    f'test-tinytc_out-rows': out.nrow, 
                    f'test-tinytc_out-cols': out.ncol,
                    f'test-tinytc_nnz': np.count_nonzero(a.get()),
                    f'test-tinytc_Runtime': dt}
